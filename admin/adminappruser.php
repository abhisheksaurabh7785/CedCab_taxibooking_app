...
$ride9 = new Ride();
	...
	$data1 = $ride9 -> adappruser($dbconnection-> conn);
	//echo $_SESSION['uid'];
    //sorting
...
if(isset($_POST['submit'])){
    ...
    $data1=$user1 -> adapprusersort($id,$dbconnection-> conn);
             //echo $data1;
...
if(isset($_POST['subm'])){
    ...
    $data1=$user2 -> adappruserfilter($id,$dbconnection-> conn);
             //echo $data1;
...
<!-- Navbar -->
	...
	<div class="wrapper">
        <h3 class="text-white">Approved User</h3>
         <!-- soting+filter-->
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <form action="adminappruser.php" method="post">
