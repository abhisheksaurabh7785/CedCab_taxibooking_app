...
$ride1 = new Ride();
	...
	$data1 = $ride1 -> adpendingreq($dbconnection-> conn);
	//echo $_SESSION['uid'];
	...
	if(isset($_GET['id'])){
		...
		if(($_GET['name'])=='str'){
		//
			$sql = $ride2 -> adpendingappr($id, $dbconnection-> conn); 
			if ($sql) {
                
				header('Location: adminpendride.php');
			}
	    }else{
	    	$sql = $ride2 -> adpendingcanc($id, $dbconnection-> conn); 
			if ($sql) {
			 		header('Location: adminpendride.php');
			 	}
...
//echo "hello";
             ...
             $data1=$ride6 -> adpendridesort($id,$dbconnection-> conn);
             //echo $data1;
            // //name sorting
            // $ride7=new Ride();
...
//echo "hello";
             ...
             $data1=$ride7 -> adpendridefilter($id,$dbconnection-> conn);
             //echo $data1;
            // //name sorting
            // $ride7=new Ride();
            // $data1=$ride7 -> adsortfare($dbconnection->conn);
...
<body class="bg-dark">
	...
	<div class="wrapper">
        <h3 class="text-white">Requested Rides</h3>
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <!-- 3dec sorting by date and fare prog -->
                    <div class="col-md-3">
                        <form action="adminpendride.php" method="post">
		            ...
		            foreach ($data1 as $row) {
		                ?>
		                    <tr>
		                        ...
		                        <td >
		                        	<a href="adminpendride.php?id=<?php echo $row['ride_id']; ?>&name=<?php echo 'str' ?>" class="btn btn-primary btn-sm">Approve</a>
		                        	<a href="adminpendride.php?id=<?php echo $row['ride_id']; ?>"class="btn btn-primary btn-sm mt-2">Cancel </a>
		                        </td>
		                    </tr>
