...
$ride5 = new Ride();
	...
	$data1 = $ride5 -> adcancride($dbconnection-> conn);
	//echo $_SESSION['uid'];
...
//echo "hello";
             ...
             $data1=$ride6 -> adcancridesort($id,$dbconnection-> conn);
             //echo $data1;
            // //name sorting
            // $ride7=new Ride();
...
//echo "hello";
             ...
             $data1=$ride7 -> adcancridefilter($id,$dbconnection-> conn);
             //echo $data1;
            // //name sorting
            // $ride7=new Ride();
            // $data1=$ride7 -> adsortfare($dbconnection->conn);
...
<body class="bg-dark">
	...
	<div class="wrapper">
        <h3 class="text-white">Cancelled Rides</h3>
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <!-- 3dec sorting by date and fare prog -->
                    <div class="col-md-3">
                        <form action="admincancride.php" method="post">
                            <select name="id" id="cars" >
                                <option value="">Sort By</option>
                                <option value="1">Date</option>
                                <option value="2">Fare</option>
                                <option value="3">Dist.</option>
