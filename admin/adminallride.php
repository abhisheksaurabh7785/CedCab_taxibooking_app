...
$ride5 = new Ride();
	...
	$data1 = $ride5 -> adallride($dbconnection-> conn);
	//echo $_SESSION['uid'];
    // 2dec night at home
    $ride6=new Ride();
...
//echo "hello";
             ...
             $data1=$ride6 -> adallridesort($id,$dbconnection-> conn);
             //echo $data1;
            // //name sorting
            // $ride7=new Ride();
...
//echo "hello";
             ...
             $data1=$ride7 -> adallridefilter($id,$dbconnection-> conn);
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <!-- 3dec sorting by date and fare prog -->
                    <div class="col-md-3">
                        <form action="adminallride.php" method="post">
