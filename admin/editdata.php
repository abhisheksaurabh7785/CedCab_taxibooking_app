...
//echo $location;
    ...
    $dbconnection->conn;
$loc1 = new Location();
	$sql = $loc1-> editloc($id,$location,$distance,$dbconnection-> conn);
...
<body >
  ...
  <div class="form-group">
    <label for="name">Edit Location</label>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Edit Distance</label>
  ...
  <a href="adminpanel.php" class="text-white  btn btn-primary  ">back to previous page</a>
   ...
   <div class="col-4"></div>
	...
	<form action="editdata.php" method="POST">
		<p class="text-white"><label for="name">edit Location<input type="text" name="location" required></label></p>
		
		<p class="text-white"><label for="distance">Distance<input type="text" name="distance" required></label></p>
