...
$dbconnection->conn;
$loc3 = new Location();
$data1 = $loc3-> viewlocation($dbconnection-> conn);
//$loc4 = new Location();
	if(isset($_GET['id'])){
		$id = $_GET['id'];
		$_SESSION['edlocid']=$id;
		//
		//$sql = $loc4 -> Editloc($id, $dbconnection-> conn); 
		//if ($sql) {
...
$loc5 = new Location();
	if(isset($_GET['name'])){
		$id = $_GET['name'];
		//
		$sql = $loc5 -> delloc($id, $dbconnection-> conn); 
		if ($sql) {
...
<body >
	...
	<div class="wrapper">
        <h3 class="text-white ml-5">Edit Location<a href="adminpanel.php" class="btn btn-info backbt">Back</a></h3>
		<table class="mx-5 ">
		            <thead>
		                <tr>
		                    <th>id</th>
		            ...
		            foreach($data1 as $row) {
		                ?>
		                    <tr>
		                        ...
		                        <td>
		                        	<a href="editlocation.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
		                        	<a href="editlocation.php?name=<?php echo $row['area_name']; ?>" class="btn btn-primary">Delete</a>
		                        </td>
		                    </tr>
