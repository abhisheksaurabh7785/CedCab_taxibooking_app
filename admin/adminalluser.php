...
$ride11 = new Ride();
	...
	$data1 = $ride11 -> adalluser($dbconnection-> conn);
    //sorting
...
if(isset($_POST['submit'])){
    ...
    $data1=$user1 -> adallusersort($id,$dbconnection-> conn);
             //echo $data1;
...
if(isset($_POST['subm'])){
    ...
    $data1=$user2 -> adalluserfilter($id,$dbconnection-> conn);
             //echo $data1;
            ...
            <div class="row m-2">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <form action="adminalluser.php" method="post">
                        ...
                        <div class="col-md-3">
                            <form action="adminalluser.php" method="post">
                                <select name="filter" id="filt" >
                                    ...
                                    <option value="4">Unblocked</option>
...
<!-- Footer -->
  <!--  <h1 class="text-center "><a href="adminpanel.php" class="text-white btn btn-primary  ">back to previous page</a></h1> -->
