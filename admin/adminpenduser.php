...
$ride6 = new Ride();
	...
	$data1 = $ride6 -> adpendusereq($dbconnection-> conn);
	//echo $_SESSION['uid'];
$ride7 = new Ride();
	if(isset($_GET['id'])){
		$id = $_GET['id'];
		//
		$sql = $ride7 -> adpenduserunblock($id, $dbconnection-> conn); 
		if ($sql) {
			header('Location: adminpenduser.php');
		}
	}
	$ride8 = new Ride();
	if(isset($_GET['id'])){
		$id = $_GET['id'];
		//
		$sql = $ride8 -> adpendusercancblock($id, $dbconnection-> conn); 
		if ($sql) {
			header('Location: adminpenduser.php');
		}
	}
...
if(isset($_POST['submit'])){
    ...
    $data1=$user1 -> adpendusersort($id,$dbconnection-> conn);
             //echo $data1;
...
if(isset($_POST['subm'])){
    ...
    $data1=$user2 -> adpenduserfilter($id,$dbconnection-> conn);
             //echo $data1;
...
<body class="bg-dark">
	...
	<div class="wrapper">
        <h3 class="text-white">Pending Users</h3>
         <!-- soting+filter-->
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <form action="adminpenduser.php" method="post">
		            ...
		            foreach ($data1 as $row) {
		                ?>
		                    <tr>
		                        ...
		                        <td class="btn-sm">
		                        	<a href="adminpenduser.php?id=<?php echo $row['id']; ?>" class="btn btn-primary ">Unblock</a>
		                        	<a href="adminpenduser.php?id=<?php echo $row['id']; ?>" class="btn btn-primary ">Block</a> 
		                        </td>
		                    </tr>
