...
$ride2 = new Ride();
	...
	$data = $ride2 -> approved($dbconnection-> conn);
    ...
    if(isset($_POST['submit'])){
	    $idb =  $_POST['id'];
	    $data=$ride1 -> usapprridesort($id,$idb,$dbconnection-> conn);
    }
    //filter method call
    $ride2=new Ride();
    if(isset($_POST['subm'])){
        ...
        $idb=$_POST['filter'];
        $data=$ride2 -> usapprcabfilter($id,$idb,$dbconnection-> conn);
    }
...
<body>
  ...
  <!--//navbar -->
	<div class="main">
		<section id="secmain">
		<div class="wrapper">
		        <h3>Approved Rides<a href="dashboard.php" class="btn btn-info backbt">Back</a></h3>
		                ...
		                ?>
		                    <tr>
		                       ...
		                       <?php echo $row['cabtype']; ?>
		                        ...
		                        <td>
		                        	<a href="uinvoice.php?id=<?php echo $row['ride_id']; ?>" class="btn btn-primary">Invoice</a>
		                        </td>
		                    </tr>
