...
$ride4 = new Ride();
	...
	$data = $ride4 -> cancelled($dbconnection-> conn);
    ...
    if(isset($_POST['submit'])){
	    $idb =  $_POST['id'];
	    $data=$ride1 -> uscancridesort($id,$idb,$dbconnection-> conn);
    }
    //filter method call
    $ride2=new Ride();
    if(isset($_POST['subm'])){
        ...
        $idb=$_POST['filter'];
        $data=$ride2 -> uscanccabfilter($id,$idb,$dbconnection-> conn);
    }
...
<body>
  ...
  <!--//navbar -->
	<div class="main">
		<section id="secmain">
		<div class="wrapper">
		        <h3>Cancelled Rides<a href="dashboard.php" class="btn btn-info backbt">Back</a></h3>
