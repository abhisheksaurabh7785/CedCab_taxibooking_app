...
$ride2 = new Ride();
	...
	$data = $ride2 -> pending($dbconnection-> conn);
    ...
    if(isset($_POST['submit'])){
	    $idb =  $_POST['id'];
	    $data=$ride1 -> uspendridesort($id,$idb,$dbconnection-> conn);
    }
    //filter method call
    $ride2=new Ride();
    if(isset($_POST['subm'])){
        ...
        $idb=$_POST['filter'];
        $data=$ride2 -> uspendcabfilter($id,$idb,$dbconnection-> conn);
    }
...
<body>
  ...
  <!--//navbar -->
	<div class="main">
		<section id="secmain">
		    <div class="wrapper">
		        <h3>Pending Rides<a href="dashboard.php" class="btn btn-info backbt">Back</a></h3>
		        <!-- <a href="profile.php" class="btn btn-info ml-5">Back</a> -->
